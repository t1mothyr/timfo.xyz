...
I first started exploring servers in 2022 on a Dell R420, [probably the loudest computer to have in your living room](https://www.reddit.com/r/homelab/comments/t9pa13/dell_poweredge_fan_control_with_ipmitool/). It did however allow me to explore UNIX through the BSD based [TrueNAS](https://www.truenas.com/) and virtualised deployments. From there, I eventually built my own server, on which I installed [Proxmox](https://www.proxmox.com/en/). This led me to dive deeper into ZFS, basic networking principles such as firewalls and containerisation through docker.

I wanted to go deeper into automation, and started to use [Ansible](https://www.redhat.com/en/ansible-collaborative/how-ansible-works) in combination with Ubuntu Server's cloud-init system to deploy my services without having to manually configure everything multiple times. Likewise, I enjoy data and so started using several services such as [Wazuh](https://wazuh.com/) for endpoint security and monitoring.

Simulaneously my course was progressing and through several units I fell in love with the challenge of networking. Networking provided a new horizon for me to explore and integrate into my burgeoning home lab, which I promptly did. It exposed me to new techniques for managing my equipment, and gave me the confidence to explore firewall technologies such as [OPNsense](https://opnsense.org/). Eventually I ended up with a fairly typical networked security setup such as a Next-Gen Firewall, VLANs and Geoblocking which serves me well to this day.
